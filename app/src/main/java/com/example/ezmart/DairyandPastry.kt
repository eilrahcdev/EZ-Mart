...
class DairyandPastry : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.dairyandpastry_activity)
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.dairyandpastry_activity)) { v, insets ->
        ...
        val backBtnDairy = findViewById<ImageButton>(R.id.backBtn_dairy)
        backBtnDairy.setOnClickListener {
            val intent = Intent(this, MainActivity::class.java)
            startActivity(intent)
            finish()
        }

        val cartIbtnDairy = findViewById<ImageButton>(R.id.cartIbtn_dairy)
        cartIbtnDairy.setOnClickListener {
        ...
        // Fetch products for "Dairy and Pastry"
        productViewModel.fetchProducts("Dairy and Pastry")
