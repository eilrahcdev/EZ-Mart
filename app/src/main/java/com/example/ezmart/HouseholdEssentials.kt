...
class HouseholdEssentials : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.householdessentials_activity)
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.householdessentials_activity)) { v, insets ->
            val systemBars = insets.getInsets(WindowInsetsCompat.Type.systemBars())
            v.setPadding(systemBars.left, systemBars.top, systemBars.right, systemBars.bottom)
            insets
        }
        //Buttons with function
        val backBtnFeatured = findViewById<ImageButton>(R.id.backBtn_household)
        ...
        val cartIbtnFeatured = findViewById<ImageButton>(R.id.cartIbtn_household)
